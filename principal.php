...
<html lang="es">
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#portfolio">Estudio</a></li>
        ...
        <section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Trabajamos Para Ti.</h3>
                </div>
                <div class="row text-center">
                    <div class="col-md-4">
                        ...
                        <h4 class="my-3">ESTUDIO</h4>
                        <p class="text-muted">Diseñamos un espacio con las herramientas mas utiles al momento de tus trabajos en disintas materias.</p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-primary"></i>
                        ...
                        <h4 class="my-3">HOBBYS</h4>
                        <p class="text-muted">Distintas herramientas diseñadas para ayudarte a relajarte y entretenerte.</p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-primary"></i>
                        ...
                        <p class="text-muted">Disfruta de este espacio libre de molestias o anuncios, si deseas nos puedes apoyar donandonos :).</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Herramientas para ayudarte en tus trabajos.</h3>
                </div>
                <div class="row">
        ...
        <section class="page-section bg-light" id="hobby">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Hobbys</h2>
                    <h3 class="section-subheading text-muted">Herramientas para ayudarte a pasar el rato.</h3>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            <a class="portfolio-link" href="musica.html">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"><i class="fas fa-plus fa-3x"></i></div>
                                </div>
                                <img class="img-fluid" src="assets/img/portfolio/01-thumbnail.jpg" alt="" />
                ...
                <ul class="timeline">
                    <li>
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>2020</h4>
                                <h4 class="subheading">Nuestro Inicio</h4>
                            </div>
                            <div class="timeline-body"><p class="text-muted">Nuestro primer CEO Alex tuvo una pequeña idea un dia luego que asistio a una conferencia de un joven programador que mostro una idea que lo dejo impactado, esa pequeña idea fue lo que inicio todo.</p></div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>Noviembre 3</h4>
                                <h4 class="subheading">Empezo Todo</h4>
                            </div>
                            <div class="timeline-body"><p class="text-muted">Luego que Alex contara su idea al segundo CEO Harvys Perez, empezo la creacion de esta pagina por GitHub, se creo el proyecto con una buena meta y un sueño.</p></div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>Noviembre 3</h4>
                                <h4 class="subheading">Funciones</h4>
                            </div>
                            <div class="timeline-body"><p class="text-muted">Ya vamos en gran avanze, el sueño se materializa y vamos por mas!!!</p></div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
        ...
        <section class="page-section bg-light" id="team">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center"><p class="large text-muted">Somos estudiantes de ingenieria de sistemas, empezamos con un sueño cuando estabamos en segundo semestre y queremos ayudarte a ti usuario.</p></div>
                </div>
            </div>
        </section>
        <!-- Contact-->
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 text-lg-right">
                        ...
                        <a data-toggle="modal" href="#terminosV">Terminos</a>
                    </div>
                </div>
            </div>
        </footer>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <h2 class="text-uppercase">Politica</h2>
                                    <p class="item-intro text-muted">Leyes de I-COM.</p>
                                    <!-- <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/01-full.jpg" alt="" /> -->
                                    <p>I-COM esta diseñado para ayudarte, nuestra politica de proteccion de datos garantiza la seguridad de tus datos, la regla principal en I-COM es que nos puedas considerar cada vez que tengas que hacer una tarea o quieras pasar el rato, si tienes alguna queja o duda o sugerencia te puedes dirigir amablemente a los CEO, siempre te ayudaremos con gusto!!! :)</p>
        ...
        <div class="portfolio-modal modal fade" id="terminosV" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="close-modal" data-dismiss="modal"><img src="assets/img/close-icon.svg" alt="Close modal" /></div>
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <p class="item-intro text-muted">Leyes de I-COM.</p>
                                    <!-- <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/01-full.jpg" alt="" /> -->
                                    <p>El presente Política de Privacidad establece los términos en que I-COM usa y protege la información que es proporcionada por sus usuarios al momento de utilizar su sitio web. Esta compañía está comprometida con la seguridad de los datos de sus usuarios. Cuando le pedimos llenar los campos de información personal con la cual usted pueda ser identificado, lo hacemos asegurando que sólo se empleará de acuerdo con los términos de este documento. Sin embargo esta Política de Privacidad puede cambiar con el tiempo o ser actualizada por lo que le recomendamos y enfatizamos revisar continuamente esta página para asegurarse que está de acuerdo con dichos cambios.
                                        ...
                                        Uso de la información recogida: Nuestro sitio web emplea la información con el fin de proporcionar el mejor servicio posible, particularmente para mantener un registro de usuarios, de pedidos en caso que aplique, y mejorar nuestros productos y servicios.  Es posible que sean enviados correos electrónicos periódicamente a través de nuestro sitio con ofertas especiales, nuevos productos y otra información publicitaria que consideremos relevante para usted o que pueda brindarle algún beneficio, estos correos electrónicos serán enviados a la dirección que usted proporcione y podrán ser cancelados en cualquier momento.I-COM está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos los sistemas más avanzados y los actualizamos constantemente para asegurarnos que no exista ningún acceso no autorizado.
                                        Cookies: Una cookie se refiere a un fichero que es enviado con la finalidad de solicitar permiso para almacenarse en su ordenador, al aceptar dicho fichero se crea y la cookie sirve entonces para tener información respecto al tráfico web, y también facilita las futuras recurrente. Otra función que tienen las cookies es que con ellas las web pueden reconocerte individualmente y por tanto brindarte el mejor servicio personalizado de su web. Nuestro sitio web emplea las cookies para poder identificar las páginas que son visitadas y su frecuencia. Esta información es empleada únicamente para análisis estadístico y después la información se elimina de forma permanente. Usted puede eliminar las cookies en cualquier momento desde su ordenador. Sin embargo las cookies ayudan a proporcionar un mejor servicio de los sitios web, estás no dan acceso a información de su ordenador ni de usted, a menos de que usted así lo quiera y la proporcione directamente. Usted puede aceptar o negar el uso de cookies, sin embargo la mayoría de navegadores aceptan cookies automáticamente pues sirve para tener un mejor servicio web. También usted puede cambiar la configuración de su ordenador para declinar las cookies. Si se declinan es posible que no pueda utilizar algunos de nuestros servicios.
                                        ...
                                        I-COM Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier momento.</p>
                                    <button class="btn btn-primary" data-dismiss="modal" type="button">
                                        <i class="fas fa-times mr-1"></i>
                                        Lei Todo,Entendi Y Acepto!
                                    </button>
                                </div>
                            </div>
                        </div>
